...
class TestDocumentCRUD:
    ...
    async def test_create_document(self, db_session: AsyncSession, test_user, test_product):
    ...
    async def test_get_by_product(self, db_session: AsyncSession, test_product, test_document):
    ...
    async def test_delete_document(self, db_session: AsyncSession, test_document):
...
class TestDocumentQueries:
    ...
    async def test_get_changelog(self, db_session: AsyncSession, test_user, test_product):
    ...
    async def test_move_to_folder(self, db_session: AsyncSession, test_document):
        """move_to_folder updates the JSONB folder path."""
        moved = await document_ops.move_to_folder(db_session, test_document.id, "executing")
...
class TestDocumentBulkOps:
    ...
    async def test_sync_status_tracking(self, db_session: AsyncSession, test_user, test_product):
